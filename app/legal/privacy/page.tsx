...
export default function PrivacyPage() {
  return (
    <LegalDoc
      ...
      sections={[
        { h: "The short version", p: ["Lectern is local-first. Your source code, prompts, and API keys stay on your device. The cloud (lectern.ai) only ever receives, with your opt-in, anonymous usage counts and end-to-end-encrypted memory/skills blobs we cannot read. We never train on your data."] },
        ...
        { h: "Your rights", p: ["Export or delete your data at any time from Settings, or by contacting privacy@lectern.ai. We honor GDPR/CCPA requests."] },
        { h: "Contact", p: ["privacy@lectern.ai"] },
      ]}
    />
  );
}
