    ...
    <LegalDoc
      ...
      sections={[
        ...
        { h: "Current subprocessors", p: [
          "Vercel — web hosting / edge for lectern.ai.",
        ...
        { h: "Changes", p: ["We post updates here and notify customers of material changes. Contact privacy@lectern.ai to subscribe to change notices."] },
      ]}
    />
  );
}
