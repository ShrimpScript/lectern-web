  ...
  return (
    <LegalDoc
      ...
      sections={[
        ...
        { h: "Acceptable use", p: ["Don't use Lectern to violate the law, infringe rights, or abuse connected providers. Don't attempt to exfiltrate other users' data or break the Hub's signing/sandboxing."] },
